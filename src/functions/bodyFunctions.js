const addColumn = (setColumns,columns,uuid,setShowSnack) => {
  ...
  const deleteItem = (itemIdUnique, columnId, columns, arrFoods, setArrFoods, addFoodWeight, setColumns) => {
  ...
  function duplicateItem(itemName, columnName, arrFoods, uuid, addFoodWeight, columns, setColumns) {
  ...
  const changeName = (itemIdUnique, columns, arrFoods, setColumns, columnName, name) => {
  ...
  const changeN_int_card = (itemIdUnique, columnName, arrFoods, uuid, addFoodWeight, columns, setColumns, gramsInt_card) => {
    const indexItem = arrFoods.findIndex(
      (element) => element.idUnique === itemIdUnique
    );
    ...
    export {addColumn, deleteItem, duplicateItem, updateFood, changeName, changeN_int_card};